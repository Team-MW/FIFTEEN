            ...
            <div className="container" style={{ maxWidth: '800px', color: '#ddd', fontFamily: "'Inter', sans-serif" }}>
                ...
                <section style={{ marginBottom: '3rem' }}>
                    ...
                    <p style={{ lineHeight: 1.8, marginBottom: '1rem' }}>
                        Le site <strong>fifteen.fr</strong> est édité par la société FIFTEEN SAS.
                        <br />Capital social : 10 000€
                        <br />Siège social : 15 Rue de la Victoire, 75009 Paris
                        <br />Numéro SIRET : 123 456 789 00012
                        <br />RCS : Paris B 123 456 789
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p style={{ lineHeight: 1.8, marginBottom: '1rem' }}>
                        Conformément à la réglementation européenne en vigueur (RGPD), vous disposez d'un droit d'accès, de rectification, d'effacement, et de portabilité des données vous concernant. Pour exercer ce droit, veuillez contacter notre DPO à : contact@fifteen.fr
                    </p>
                </section>
            </div>
        </main>
